...
public class ItemController {
    ...
    public String create(@Validated @ModelAttribute("form") BookForm form,
    ...
    public String updateItemForm(@PathVariable("itemId") Long itemId, Model model) {
        Book item = (Book)itemsService.findOne(itemId);
...
//        itemsService.saveItem(book);
        ...
        itemsService.updateItem(itemId, form.getName(), form.getPrice(), form.getStockQuantity());
        return "redirect:/items";
    }
}
